...
(function (m, p) {
  ...
  function p(a) {
    return new Promise(function (h, c) {
      ...
      if (g.AMapUI === b.failed)
        ...
        l.appendChild(k);
      } else if (g.AMapUI === b.loaded)
        a.version && a.version !== d.AMapUI.version
          ? c("不允许多个版本 AMapUI 混用")
          : f.length
          ? window.AMapUI.loadUI(f, function () {
              for (var a = 0, b = f.length; a < b; a++) {
  ...
  function r(a) {
    return new Promise(function (h, c) {
      ...
      } else if (g.Loca === b.loaded)
        a.version && a.version !== d.Loca.version
          ? c("不允许多个版本 Loca 混用")
          : h();
      else
        a.version && a.version !== d.Loca.version
          ? c("不允许多个版本 Loca 混用")
          : n.Loca.push(function (a) {
              a ? c(a) : c();
            });
    });
  }
        ...
        if (g.AMap == b.failed) c("");
          ...
          f
            ? (window.AMap &&
                ...
                c("禁止多种API加载方式混用"),
              (d.key = f),
              (d.AMap.version = e || d.AMap.version),
              (d.AMap.plugins = l || d.AMap.plugins),
              (g.AMap = b.loading),
              (e = document.body || document.head),
              (window.___onAPILoaded = function (d) {
          ...
          if (a.key && a.key !== d.key) c("多个不一致的 key");
            ...
            if (a.plugins)
              for (e = 0; e < a.plugins.length; e += 1)
                -1 == d.AMap.plugins.indexOf(a.plugins[e]) &&
                  f.push(a.plugins[e]);
            if (f.length)
